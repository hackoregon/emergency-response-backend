...
NAMESPACE="/production/2017/API" # future-proofing this script for subsequent or past containers
PROJECT_CANONICAL_NAME="emergency-service" # must be set to each project's "Final naming convention" from here https://github.com/hackoregon/civic-devops/issues/1
